    ...
    <footer className="px-4 mt-4 divide-y text-gray-800" style={{ backgroundColor: color2 }}>
      <div className="container flex flex-col justify-between py-10 lg:px-2 lg:mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-1 text-lg gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
          ...
          {store?.facebook || store?.twitter || store?.instagram || store?.youtube ?
            <div className="space-y-3">
              <div className="text-base uppercase font-bold tracking-tight" style={{ color: color1 }}>Social media</div>
              <div className="flex justify-start space-x-3">
                {store?.facebook ? <a rel="noopener noreferrer" href={store?.facebook} title="Facebook" className="flex items-center p-1">
                ...
                {store?.twitter ? <a rel="noopener noreferrer" href={store?.twitter} title="Twitter" className="flex items-center p-1">
                ...
                {store?.instagram ? <a rel="noopener noreferrer" href={store?.instagram} title="Instagram" className="flex items-center p-1">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" style={{ color: color1 }} className="w-5 h-5 fill-current hover:brightness-150">
                ...
                {store?.youtube ? <a rel="noopener noreferrer" href={store?.youtube} title="Youtube" className="flex items-center p-1">
      ...
      <div className="py-6 text-sm text-center dark:text-gray-600">Powered by <a href='https://growo.store'>Growo</a>. © 2026 All rights reserved.</div>
    </footer>
  );
}