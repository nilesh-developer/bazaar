                    ...
                    <div className='mt-3'>
                        <form onSubmit={handleSubmit} className='grid grid-flow-row mt-6'>
                            ...
                            <input
                                ...
                                className="border outline-none rounded-lg px-3 py-3 text-black bg-transparent w-full max-w-xs"
                            />
                            <button className="bg-zinc-950 text-white py-2 rounded-lg tracking-tight hover:bg-zinc-900 mt-6 mb-10 w-44">{!loading ? "Update Password" : <span className="loading loading-spinner loading-md"></span>}</button>
                        </form>
                    </div>
                </div>
            </div>
