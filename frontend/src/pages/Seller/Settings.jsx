      ...
      <div className='mx-5'>
        <div className='grid grid-rows-3 lg:grid-rows-none lg:grid-cols-3 gap-6'>
          <div className='bg-gray-50 w-auto h-fit p-5 rounded-md'>
            ...
            <div className='flex flex-wrap justify-center mt-5'>
              <Link to="../edit-profile">
                <button className="bg-emerald-600 text-sm font-semibold px-4 py-3 rounded-lg text-gray-50">EDIT PROFILE</button>
              </Link>
            </div>
          </div>
          ...
          <div className='bg-gray-50 w-auto h-fit p-5 rounded-md'>
            ...
            <div className='flex flex-wrap justify-center mt-5'>
              <Link to="../payments">
                <button className="bg-emerald-600 text-sm font-semibold px-4 py-3 rounded-lg text-gray-50">UPDATE PAYMENT</button>
              </Link>
            </div>
          </div>
          ...
          <div className='bg-gray-50 w-auto h-fit p-5 rounded-md'>
            ...
            <h2 className='text-center text-xl tracking-tight font-semibold'>Change your personal information</h2>
            <div className='flex flex-wrap justify-center mt-5'>
                <button onClick={handleShare} className="bg-emerald-600 text-sm font-semibold px-4 py-3 rounded-lg text-gray-50">SHARE</button>
              {/* <Link to="/">
              </Link> */}
            </div>
          </div>
