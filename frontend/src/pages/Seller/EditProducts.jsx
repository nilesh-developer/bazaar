            ...
            <div className='flex justify-between'>
                ...
                <div>
                    <button
                        ...
                        className="w-full px-4 py-2 font-bold text-white bg-zinc-950 rounded-md hover:bg-zinc-950 focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2"
                    >
                        Update
                    </button>
                </div>
