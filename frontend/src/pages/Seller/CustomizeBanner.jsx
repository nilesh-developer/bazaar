      ...
      <div className='lg:my-7 lg:mx-10 my-3 mx-3'>
        ...
        <div className='mt-8'>
          <form className='grid grid-flow-row'>
            ...
            <button onClick={handleSubmit} className="bg-zinc-950 text-white py-2 rounded-lg hover:bg-zinc-800 text-lg mt-6 w-28">{uploading ? <span className="loading loading-spinner loading-sm"></span> : "Save"}</button>
          </form>
        </div>
      </div>
    </div>
