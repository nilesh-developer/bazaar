...
export default function AddDigitalProduct() {
    ...
    const validate = () => {
        ...
        if (deliveryMethod === "upload" && digitalFiles.length === 0) return "Upload at least one digital file";
        return null;
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setUploading(true);
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/product/add-digital-product`, formData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                },
                // optional: onUploadProgress to show progress
            });
            toast.success(response.data.message || "Digital product added");
            // reset form
            setProduct({
                name: "",
                shortDescription: "",
    ...
    return (
        <div data-theme="light" className="bg-white p-4 lg:p-10 lg:min-h-screen h-full lg:mb-0 mb-20">
            <div className="flex justify-between">
                <h2 className="text-2xl lg:text-3xl font-extrabold text-gray-900">Add Digital Product</h2>
                <div>
                    <button
            ...
            <div className="lg:flex lg:gap-3">
                ...
                <div className="w-full h-auto lg:mt-0 space-y-3 rounded-lg">
                    <div className="w-full py-3 bg-white rounded-lg">
                        ...
                        <p className="text-gray-600 font-semibold text-sm tracking-tight">
                            Add title, prices and category — then add digital delivery.
                        </p>
                ...
                <div className="w-full h-auto mt-6 lg:mt-0 space-y-6 rounded-lg">
                    ...
                    <ProductImagesUpload images={images} setImages={setImages} />
