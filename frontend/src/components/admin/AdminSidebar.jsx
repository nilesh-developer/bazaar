        ...
        <>
            <div className="divide-y divide-gray-300 bg-white">
                ...
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                    ...
                    <li>
                        <NavLink to="sellers" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-zinc-950 font-bold rounded-lg" : ""}`}>
                ...
                <ul className="pt-4 pb-2 space-y-1 text-sm">
                    ...
                    <li>
                        <NavLink to="/admin/change-password" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-zinc-950 font-bold rounded-lg" : ""}`}>
                            <KeySquare className='h-5 w-5 text-[fill-current]' />
                            <span>Change Password</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/admin/logout" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-zinc-950 font-bold rounded-lg" : ""}`}>
