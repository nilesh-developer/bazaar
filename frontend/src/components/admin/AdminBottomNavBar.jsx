...
function AdminBottomNavBar() {
    return (
        <div data-theme="light" className="btm-nav lg:hidden bottom-0">
            ...
            <NavLink to="sellers" className={({ isActive }) => `${isActive ? "active text-zinc-950 font-bold" : ""}`}>
            ...
            <NavLink to="customers" className={({ isActive }) => `${isActive ? "active text-zinc-950 font-bold" : ""}`}>
