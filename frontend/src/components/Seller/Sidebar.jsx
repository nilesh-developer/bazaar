        ...
        <>
            ...
            <div className="divide-y divide-gray-300 bg-white">
                <ul className="pt-2 pb-4 space-y-1 text-sm">
                    <li>
                        <NavLink to="dashboard" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                            <Grid2X2 className='w-5 h-5 text-[fill-current]'/>
                            <span>Dashboard</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="products" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                            <Box className='w-5 h-5 text-[fill-current]'/>
                            <span>Products</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="orders" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                            <ShoppingBasket className='w-5 h-5 text-[fill-current]'/>
                            <span>Orders</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="categories" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                            <Menu className='w-5 h-5 text-[fill-current]'/>
                            <span>Category</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="customers" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                    ...
                    <li>
                        <NavLink to="payments" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                            <Landmark className='w-5 h-5 text-[fill-current]'/>
                            <span>Payments</span>
                        </NavLink>
                    </li>
                    {/* <li>
                        <NavLink to="transactions" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                    ...
                    <li>
                        <NavLink to="subscriptions" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                        <Calendar className='w-5 h-5 text-[fill-current]'/>
                        <span>Subscription</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="edit-store" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                ...
                <ul className="pt-4 pb-2 space-y-1 text-sm">
                    <li>
                        <NavLink to="settings" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
                            <Settings className='w-5 h-5 text-[fill-current]'/>
                            <span>Settings</span>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to="/logout" className={({ isActive }) => `flex items-center p-2 space-x-3 rounded-md ${isActive ? "bg-gray-100 text-emerald-600 font-bold rounded-lg" : ""}`}>
