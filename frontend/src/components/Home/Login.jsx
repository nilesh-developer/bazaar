    ...
    return (
        <div className='flex flex-wrap justify-center items-center h-auto py-10 mt-10'>
            <div className="w-96 mx-auto bg-white p-8 rounded-2xl shadow-none lg:shadow-md">
                ...
                <h3 className="text-gray-700">Not registered? <Link className='font-bold text-zinc-900' to="/signup">Register</Link></h3>
                ...
                <div className="form-input mt-5 mb-6">
                    ...
                    <button type="submit"
                        className="bg-zinc-900 w-full text-xl font-bold text-white py-4 px-4 rounded-md hover:bg-zinc-800 transition duration-200">{!loadingBtn ? "Login" : <span className="loading loading-spinner loading-md"></span>}</button>
                </form>
            </div>
        </div>
    )
