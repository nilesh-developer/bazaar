        ...
        <header className="bg-white shadow-sm">
            <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3 lg:px-8" aria-label="Global">
                ...
                <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                    <NavLink to="/" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                        Home
                    </NavLink>
                    {/* <NavLink to="pricing" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                        Pricing
                    </NavLink> */}
                    <NavLink to="terms-and-conditions" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                        Terms & Conditions
                    </NavLink>
                    {/* <div data-theme="light" className="dropdown relative">
                        ...
                        <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                            <li><NavLink to="privacy-policy" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                                Privacy Policy
                            </NavLink></li>
                            <li><NavLink to="refund-policy" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                                Refund Policy
                            </NavLink></li>
                            <li><NavLink to="shipping-policy" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                                Shipping Policy
                            </NavLink></li>
                            <li><NavLink to="cookie-policy" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                                Cookie Policy
                            </NavLink></li>
                        </ul>
                    </div> */}
                    ...
                    <NavLink to="contact-us" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                        Contact Us
                    </NavLink>
                    <NavLink to="about-us" className={({ isActive }) => `text-sm font-semibold leading-6 ${isActive ? "text-green-600" : " text-zinc-900"}`}>
                        About Us
                    </NavLink>
                </PopoverGroup>
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    {token ?
                        ...
                        :
                        <Link to="signup" className="text-sm font-semibold leading-6 text-green-600">
                            ...
                            <div className="py-6">
                                {token ?
                                    ...
                                    : <>
                                        <Link
                                            to="login"
                                            className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-green-600 hover:bg-green-50"
                                        >
                                            <button onClick={() => setMobileMenuOpen(false)}>Log in</button>
                                        </Link>
                                        <Link
                                            to="signup"
                                            className="-mx-3 block rounded-lg px-3 py-2.5 text-base bg-green-600 font-semibold leading-7 text-green-50"
                                        >
