    ...
    return (
        <div className="max-w-lg mx-auto p-6 my-8 bg-white bg-transparent rounded-lg shadow-lg mt-20">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button
                    type="submit"
                    className="w-full bg-black text-white py-2 rounded-lg hover:bg-black focus:outline-none focus:ring focus:ring-blue-300"
                >
                    Send Message
                </button>
            </form>
            <div className="mb-8 text-gray-600 text-md mt-10">
                ...
                <ul className="list-disc list-inside">
                    <li><strong>Email:</strong> eazzy@gmail.com</li>
