  ...
  return (
    <div className="min-h-screen bg-white text-black relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 via-white to-green-500/5"></div>
        <div className="absolute inset-0" style={{
          background: `radial-gradient(circle at ${50 + Math.sin(scrollY * 0.001) * 20}% ${50 + Math.cos(scrollY * 0.001) * 20}%, rgba(34,197,94,0.1) 0%, transparent 50%)`
        }}></div>
      </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pt-32 pb-12">
        <div className="max-w-5xl mx-auto text-center z-10">
          <div className="mb-8">
            <span className="inline-block px-4 py-2 bg-gradient-to-r from-green-500/20 to-green-600/20 rounded-full text-sm border border-green-400/30 backdrop-blur-sm text-green-700 font-semibold">🚀 Launch your store in seconds, not hours</span>
          </div>
          <h1 className="text-4xl md:text-7xl font-bold mb-6">
            <span className="bg-gradient-to-r from-black via-green-600 to-black bg-clip-text text-transparent">Build Your</span>
            <br />
          ...
          <div className="flex flex-wrap justify-center gap-6 text-gray-600">
            <div className="flex items-center"><Check className="text-green-500 mr-2" size={16} />No Setup Fees</div>
            <div className="flex items-center"><Check className="text-green-500 mr-2" size={16} />Free Subdomain</div>
            <div className="flex items-center"><Check className="text-green-500 mr-2" size={16} />Built-in Payments</div>
            <div className="flex items-center"><Check className="text-green-500 mr-2" size={16} />Weekly Payouts</div>
          </div>
        </div>
        {/* Floating Elements */}
        <div className="absolute top-1/4 left-10 w-20 h-20 bg-gradient-to-r from-green-500/20 to-green-600/20 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-10 w-32 h-32 bg-gradient-to-r from-green-400/20 to-green-600/20 rounded-full blur-xl animate-pulse" style={{animationDelay: '1s'}}></div>
        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <ChevronDown className="text-green-500/60" size={24} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group relative bg-gradient-to-b from-green-100/40 to-white/80 backdrop-blur-sm rounded-3xl p-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-500 transform hover:scale-105 shadow-md">
                <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">{feature.icon}</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl group-hover:scale-110 transition-transform">1</div>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl group-hover:scale-110 transition-transform">2</div>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl group-hover:scale-110 transition-transform">3</div>
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-green-100/40 to-white/80 backdrop-blur-sm rounded-3xl p-8 border border-green-500/20 hover:border-green-400/40 transition-all duration-500 shadow-md">
            <div className="text-center mb-8">
              <div className="inline-block px-4 py-2 bg-gradient-to-r from-green-500/20 to-green-600/20 rounded-full text-sm border border-green-400/30 backdrop-blur-sm mb-4 text-green-700 font-semibold">Most Popular</div>
              <h3 className="text-3xl font-bold mb-2 text-black">Pay As You Grow</h3>
              <div className="flex items-center justify-center mb-4">
                <span className="text-5xl font-bold bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">5%</span>
            ...
            {/* <Link to="/signup" ><button className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-green-400 hover:to-green-500 transition-all transform hover:scale-105 shadow-md">Start Building Your Store</button></Link> */}
            <a href="/signup" ><button className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-green-400 hover:to-green-500 transition-all transform hover:scale-105 shadow-md">Start Building Your Store</button></a>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="py-20 px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-green-100/40 to-white/80 backdrop-blur-sm border border-green-500/20 p-8 shadow-md">
            <div className="flex transition-transform duration-500" style={{transform: `translateX(-${currentSlide * 100}%)`}}>
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 text-center px-2">
                  <div className="flex justify-center mb-4">{[...Array(testimonial.rating)].map((_, i) => (<Star key={i} className="text-green-500 fill-current" size={20} />))}</div>
      ...
      <section className="py-20 px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-6"><span className="bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent animate-gradient">Ready to Start Selling?</span></h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {/* <Link to="/signup" className="bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-green-400 hover:to-green-500 transition-all transform hover:scale-105 shadow-md"><button>Create Your Store Now</button></Link>
            <Link to="/contact-us" className="px-8 py-4 rounded-full text-lg font-semibold border border-green-500/40 hover:border-green-400 backdrop-blur-sm hover:bg-green-500/5 transition-all text-black">Talk to Sales</Link> */}
            <a href="/signup" className="bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-green-400 hover:to-green-500 transition-all transform hover:scale-105 shadow-md"><button>Create Your Store Now</button></a>
            <a href="https://youtu.be/P3uvqfF1cRY?si=cPubx4YBNvPfGCCf" className="px-8 py-4 rounded-full text-lg font-semibold border border-green-500/40 hover:border-green-400 backdrop-blur-sm hover:bg-green-500/5 transition-all text-black">Watch Demo</a>
          </div>
        </div>
      </section>
      ...
      <style jsx>{`
        ...
        .animate-gradient {
          linear-gradient(-45deg, #064e3b, #065f46, #047857, #0f766e);
