...
const StoreBuilderLanding = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Only 3% on successful online payments. No hidden costs or monthly fees"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white text-black relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-black/10 via-white to-black/5"></div>
        <div className="absolute inset-0" style={{
          background: `radial-gradient(circle at ${50 + Math.sin(scrollY * 0.001) * 20}% ${50 + Math.cos(scrollY * 0.001) * 20}%, rgba(0,0,0,0.08) 0%, transparent 50%)`
        }}></div>
      </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pt-32 pb-12">
        <div className="max-w-5xl mx-auto text-center z-10">
          ...
          <h1 className="text-4xl md:text-7xl font-bold mb-6">
            <span className="bg-gradient-to-r from-black via-gray-700 to-black bg-clip-text text-transparent">Build Your</span>
            <br />
            <span className="bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent animate-gradient">Online Store</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link to="/signup" className="group bg-gradient-to-r from-black to-gray-800 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-gray-700 hover:to-black transition-all transform hover:scale-105 shadow-md flex items-center justify-center"><button >Create Store Now<ArrowRight className="inline-block ml-2 group-hover:translate-x-1 transition-transform" /></button></Link>
            <Link to="https://youtu.be/JJ-WRmY9iJc?si=PMrf930XP3E9XgYv" className="group flex items-center justify-center px-8 py-4 rounded-full text-lg font-semibold border border-black/20 hover:border-black/40 backdrop-blur-sm hover:bg-black/5 transition-all text-black"><Play className="mr-2 group-hover:scale-110 transition-transform" size={20} /> Watch Demo</Link>
          </div>
          <div className="flex flex-wrap justify-center gap-6 text-gray-600">
            <div className="flex items-center"><Check className="text-black mr-2" size={16} />No Setup Fees</div>
            <div className="flex items-center"><Check className="text-black mr-2" size={16} />Free Subdomain</div>
            <div className="flex items-center"><Check className="text-black mr-2" size={16} />Built-in Payments</div>
            <div className="flex items-center"><Check className="text-black mr-2" size={16} />Weekly Payouts</div>
          </div>
        </div>
        {/* Floating Elements */}
        <div className="absolute top-1/4 left-10 w-20 h-20 bg-gradient-to-r from-black/10 to-gray-700/10 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-10 w-32 h-32 bg-gradient-to-r from-gray-700/10 to-black/10 rounded-full blur-xl animate-pulse" style={{animationDelay: '1s'}}></div>
        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <ChevronDown className="text-black/40" size={24} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group relative bg-gradient-to-b from-black/5 to-white/80 backdrop-blur-sm rounded-3xl p-8 border border-black/10 hover:border-black/30 transition-all duration-500 transform hover:scale-105 shadow-md">
                <div className="w-16 h-16 bg-gradient-to-r from-black to-gray-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">{feature.icon}</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-r from-black to-gray-700 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl group-hover:scale-110 transition-transform">1</div>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-r from-black to-gray-700 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl group-hover:scale-110 transition-transform">2</div>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-gradient-to-r from-black to-gray-700 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl group-hover:scale-110 transition-transform">3</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-black/5 to-white/80 backdrop-blur-sm rounded-3xl p-8 border border-black/10 hover:border-black/30 transition-all duration-500 shadow-md">
            <div className="text-center mb-8">
              <div className="inline-block px-4 py-2 bg-gradient-to-r from-black/10 to-gray-700/10 rounded-full text-sm border border-black/20 backdrop-blur-sm mb-4 text-black font-semibold">Most Popular</div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              {pricingFeatures.map((feature, index) => (
                <div key={index} className="flex items-center">
                  <Check className="text-black mr-3 flex-shrink-0" size={16} />
                  <span className="text-gray-800">{feature}</span>
                </div>
              ))}
            </div>
            <Link to="/signup" ><button className="w-full bg-gradient-to-r from-black to-gray-800 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-gray-700 hover:to-black transition-all transform hover:scale-105 shadow-md">Start Building Your Store</button></Link>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="py-20 px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-black/5 to-white/80 backdrop-blur-sm border border-black/10 p-8 shadow-md">
            <div className="flex transition-transform duration-500" style={{transform: `translateX(-${currentSlide * 100}%)`}}>
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 text-center px-2">
                  <div className="flex justify-center mb-4">{[...Array(testimonial.rating)].map((_, i) => (<Star key={i} className="text-black fill-current" size={20} />))}</div>
      ...
      <section className="py-20 px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-6"><span className="bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent animate-gradient">Ready to Start Selling?</span></h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup" className="bg-gradient-to-r from-black to-gray-800 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-gray-700 hover:to-black transition-all transform hover:scale-105 shadow-md"><button>Create Your Store Now</button></Link>
            <Link to="/contact-us" className="px-8 py-4 rounded-full text-lg font-semibold border border-black/20 hover:border-black/40 backdrop-blur-sm hover:bg-black/5 transition-all text-black">Talk to Sales</Link>
          </div>
        </div>
      </section>

      {/* Footer */}
      {/* <footer className="py-12 px-4 sm:px-6 border-t border-black/10 relative z-10 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <div className="text-3xl font-bold bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent mb-4">StoreBuilder</div>
      ...
      <style jsx>{`
        ...
        .animate-gradient {
          background: linear-gradient(-45deg, #222, #444, #888, #000);
